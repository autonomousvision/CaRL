#!/bin/bash
#SBATCH --job-name=PPO_166
#SBATCH --ntasks-per-node=1
#SBATCH --nodes=2
#SBATCH --time=3-00:00
#SBATCH --gres=gpu:9
#SBATCH --cpus-per-task=216
#SBATCH --output=/mnt/lustre/work/geiger/bjaeger25/ad_planning/2_carla/results/logs/PPO_166_%a_%A.out
#SBATCH --error=/mnt/lustre/work/geiger/bjaeger25/ad_planning/2_carla/results/logs/PPO_166_%a_%A.err
