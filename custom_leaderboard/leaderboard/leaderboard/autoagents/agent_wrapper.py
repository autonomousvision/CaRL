...
class AgentWrapper(object):
    ...
    def setup_sensors(self, vehicle):
        ...
        if len(sensors) > 0:
            ...
            # TODO NOTE for performance reasons we should tune this if using sensors.
    ...
    def cleanup(self):
        ...
        """
        # NOTE we do not clear sensors and the ego vehicle anymore and rather place the ego vehicle with sensor setup
        # to another location.
        # for i, _ in enumerate(self._sensors_list):
        #     if self._sensors_list[i] is not None:
        #         self._sensors_list[i].stop()
                  # TODO might need to do tick between stop and destroy in sync mode
        #         self._sensors_list[i].destroy()
        #         self._sensors_list[i] = None
        #
        # self._sensors_list.clear()
        # self.sensor_list_names.clear()
        # self._agent.sensor_interface._sensors_objects.clear()
        # del self._agent.sensor_interface._data_buffers
        # del self._agent.sensor_interface
